  ...
  <Tile className="xs:w-[250px] w-full">
    ...
    >
      <div
        ...
        className="bg-tertiary flex flex-col justify-evenly items-center rounded-[20px] px-12 py-5 min-h-[280px]"
      >
        <img
          src={icon}
          alt="web-development"
  ...
  return (
    <>
      ...
      >
        ...
        and Java, and expertise in frameworks like React, Node.js, and
